...
public class WikiWidget extends HorizontalPanel{
	...
	public static WikiWidget createWikiWidgetByHtml(){
		boolean readOnly=false;
		 RootPanel panel=RootPanel.get(PEOPERTY_READ_ONLY);
	      ...
	      String defaultValue=ValueUtils.getFormValueById(PEOPERTY_DEFAULT_ID, "");
	      String session_id=ValueUtils.getFormValueById(PEOPERTY_SESSION_ID,"");
	      
	      return new WikiWidget(readOnly, session_id, defaultValue);
	}
